...
use super::{Parser, ParserResult, errors::{Err, ParseError}, state::ParserState, types::Ranged};
...
pub(super) fn repeated<'a, P, T>(parser: P, range: impl RangeBounds<usize>) -> impl Parser<'a, Vec<T>>
where
    P: Parser<'a, T>,
{
